...
DEBUG = False   # production/testing stage
...
AWS_ACCESS_KEY_ID = os.environ.get('AWS_ACCESS_KEY_ID') #get it when creating IAM user
AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY') #get it when creating IAM user
